...
export default memo(function EditTextButton({
  ...
  const { completion, complete, isLoading, stop } = useCompletion({
    ...
    body: { responseLanguage: responseLanguage.value },
    onFinish: async () => {
      onReset();
    },
    onError: () => {
...
${selectedStatus.value}, ${
          textTopic.value === "general"
            ? ""
            : `keeping in mind that the topic is ${textTopic.value}. Use terminology and tone suitable for this domain`
        }
[END USER PROMPT]
